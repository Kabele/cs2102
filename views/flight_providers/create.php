					...
					<form action="" class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-6 col-xs-12">
								<input type="text" class="form-control" id="airlinecode-container" placeholder="2X">
							</div>
						</div>
						<div class="form-group">
							<label for="name-container" class="col-sm-6 col-xs-12 control-label">Official Name of the Airline</label>
							<div class="col-sm-6 col-xs-12">
								<input type="text" class="form-control" id="name-container" placeholder="Singapore Airlines">
							</div>
						</div>
						<div class="form-group">
							<label for="logo-container" class="col-sm-6 col-xs-12 control-label">URL to Airline Logo</label>
							<div class="col-sm-6 col-xs-12">
								<input type="text" class="form-control" id="logo-container" placeholder="http://img2.wikia.nocookie.net/__cb20100506081728/logopedia/images/f/fa/Singapore_Airlines.svg">
							</div>
						</div>
						<div class="form-group">
